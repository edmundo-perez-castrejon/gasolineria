<table class="table" BORDER="0" cellspacing="-5" cellpadding="2" width="70%" >
    <tr>
        <td colspan="4"><h3><?php echo $cliente[0]['CLAVE_CLIENTE'].' '.utf8_decode($cliente[0]['RAZON_SOCIAL'])  ?></h3></td>
    </tr>
    <tr>
